                    ...
                    <div class="d-inline-flex align-items-center">
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                @guest
                                <a href="{{route('loginForm')}}" class="dropdown-item" type="button">Sign in </a>

                                <a href="{{route('registerForm')}}" class="dropdown-item"> Sign Up </a>
                                @endguest
                                ...
                                {{-- <a href="{{route('loginForm')}}"> <button class="dropdown-item" type="button">Sign
                                    in</button> </a> --}}
